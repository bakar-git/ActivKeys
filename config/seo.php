...
return [
    ...
    'title' => [
         ...
         */
        'homepage_title' => 'ActivKeys | Enterprise License Key Management Platform',
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'ActivKeys is a Microsoft product key management platform for IT teams and resellers to validate keys in seconds, track MAK activations, and manage license inventory at scale.',
    ],
