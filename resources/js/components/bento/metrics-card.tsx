  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        ...
        <ScrambleNumber target="99.9%" label="Accuracy" delay={800} />
        <ScrambleNumber target="99.97%" label="Uptime SLA" delay={1100} />
        <ScrambleNumber target="2.3M" label="Keys Verified" delay={1400} />
      </div>
    </div>
  )
}
