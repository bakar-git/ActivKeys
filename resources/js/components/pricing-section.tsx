...
const TIERS: Tier[] = [
  {
    ...
    period: "/ month",
    tag: null,
    description: "Small teams. Up to 50K validations per month. Essential features.",
    features: [
      { text: "50K validations / month", included: true },
      { text: "Real-time key validation", included: true },
      { text: "Activation tracking", included: true },
  ...
  },
  {
    ...
    period: "/ month",
    tag: "RECOMMENDED",
    description: "Growing companies. Unlimited validations. Advanced security & compliance.",
    features: [
  ...
  },
  {
    ...
    period: "",
    tag: null,
    description: "Large-scale operations. White-label. On-premise deployment available.",
    features: [
      ...
      >
        <div className="flex flex-col gap-3">
          ...
          <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed max-w-md">
            All plans include real-time validation, activation tracking, API access, and comprehensive audit logs.
          </p>
        </div>
        <StatusLine />
      </motion.div>
